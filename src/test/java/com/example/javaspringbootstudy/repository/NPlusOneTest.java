...
public class NPlusOneTest {
    ...
    void nPlusOneEager1_3() {
        List<UserEager> results = entityManager.createQuery(
                        " select a " +
                                " from UserEager a ", UserEager.class)
                .setHint("javax.persistence.fetchgraph", entityManager.getEntityGraph("UserEager.withOrder"))
                .getResultList();
    ...
    void nPlusOneLazy2_3() {
        List<UserLazy> results = entityManager.createQuery(
                        " select a " +
                                " from UserLazy a ", UserLazy.class)
                .setHint("javax.persistence.fetchgraph", entityManager.getEntityGraph("UserLazy.withOrder"))
                .getResultList();
